...
public class UDPOutputMetaData implements PluginMetaData {
    private static final String PLUGIN_PROPERTIES = "org.graylog.plugins.graylog-plugin-udpsender/graylog-plugin.properties";
    ...
    @Override
    public URI getURL() {
        return URI.create("https://github.com/graylog-labs/org.graylog.plugins.graylog-plugin-udpsender");
    }
